...
class NMTLossCompute(LossComputeBase):
    ...
    def compute_loss(self, batch, output1, output2, target, **kwargs):
        """ See base class for args description. """
        scores1 = self.generator(self.bottle(output2))
        scores1_data = scores1.data.clone()
        
        scores2 = self.generator2(self.bottle(output2))
        scores1_data = scores2.data.clone()
        ...
        loss = self.criterion(scores1, target)
