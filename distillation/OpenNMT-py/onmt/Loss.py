...
class LossComputeBase(nn.Module):
    ...
    """
    def __init__(self, generator, tgt_vocab, logsoftmax):
...
class NMTLossCompute(LossComputeBase):
    ...
    """
    def __init__(self, generator, tgt_vocab, logsoftmax):
        super(NMTLossCompute, self).__init__(generator, tgt_vocab, logsoftmax)
    ...
    def compute_loss(self, batch, output, target, **kwargs):
        ...
        scores = self.logsoftmax(((self.generator(self.bottle(output)))))
        #print(scores)
